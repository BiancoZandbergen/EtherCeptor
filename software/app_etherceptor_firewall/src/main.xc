...
int main()
{
  ...
  interface config_if config_if[3];
  ...
  par {
    ...
    on tile[0]: packet_handler(eth1_i_cfg[CFG_TO_PACKET_HANDLER],
                            ...
                            led_if0, stats_if[0], config_if[0], IF_ETH1);
    on tile[0].core[1]: config_handler(config_if);

    on tile[0].core[1]: led_handler(t0_p_led, led_if0);
    on tile[0]: serial_handler(i_tx, i_rx, stats_if, config_if[2]);
    ...
    on tile[1]: packet_handler(eth2_i_cfg[CFG_TO_PACKET_HANDLER],
                            ...
                            led_if1, stats_if[1], config_if[1], IF_ETH2);
